...
<div id="top"></div>
	<div id="total_wrapper">
		...
		<div id="content_update_box">
			<h3>의견 반영 업데이트</h3>
			<form name="content_update_form" action="mng_content_update.jsp?idx=<%= rs_update.getInt(1)%>">
				<table>
					<tr><td colspan="2" class="td_line"></td></tr>
					<tr>
					...
					<tr>
						<td class="up_title"> ▷ 핵심 단어</td>
						<td><input type="text" class="textbox" name="up_keyword" value="<%= rs_update.getString(15)%>"></td>
					</tr>
					<tr><td colspan="2" class="td_line"></td></tr>
					<tr>
						<td class="up_title" style="background-color:#8d8dc7"> ▷ 핵심 요약</td>
						<td><textarea name="up_explan" cols="95" rows="1"><%= rs_update.getString(16)%></textarea></td>
					</tr>
					
					<tr>
						<td class="up_title" style="background-color:#8d8dc7"> ▷ 상세 내용</td>
						<td><textarea name="up_detail" cols="95" rows="20"><%= rs_update.getString(17)%></textarea></td>
					</tr>
					<tr><td colspan="2" class="td_line"></td></tr>
				</table>
				<input type="button" class="button" name="update" value="정보 수정" onclick="location.href='mng_content_update.jsp?idx=<%= rs_update.getInt(1)%>';">
			</form>
